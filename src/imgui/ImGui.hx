...
typedef ImGuiWindowDockStyleCol = imguicpp.ImGui.ImGuiWindowDockStyleCol;
...
typedef ImGuiScrollFlags = imguicpp.ImGui.ImGuiScrollFlags;
...
typedef ImGuiKeyPrivate = imguicpp.ImGui.ImGuiKeyPrivate;
...
typedef ImGuiInputTextFlagsPrivate = imguicpp.ImGui.ImGuiInputTextFlagsPrivate;
typedef ImGuiInputSource = imguicpp.ImGui.ImGuiInputSource;
typedef ImGuiInputReadMode = imguicpp.ImGui.ImGuiInputReadMode;
typedef ImGuiInputEventType = imguicpp.ImGui.ImGuiInputEventType;
...
typedef ImGuiDockNodeState = imguicpp.ImGui.ImGuiDockNodeState;
typedef ImGuiDockNodeFlags = imguicpp.ImGui.ImGuiDockNodeFlags;
typedef ImGuiDockNodeFlagsPrivate = imguicpp.ImGui.ImGuiDockNodeFlagsPrivate;
...
typedef ImGuiDataAuthority = imguicpp.ImGui.ImGuiDataAuthority;
...
typedef ImGuiComboFlagsPrivate = imguicpp.ImGui.ImGuiComboFlagsPrivate;
...
typedef ImGuiActivateFlags = imguicpp.ImGui.ImGuiActivateFlags;
